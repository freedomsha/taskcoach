...
class SpeedMeter(BufferedWindow):
    ...
    def Draw(self, dc):
        ...
        centerX = old_div(self.faceBitmap.GetWidth(),2)
        centerY = old_div(self.faceBitmap.GetHeight(),2)
        ...
        for ii, interval in enumerate(intervals):
            ...
            angletext = old_div(-((pi/2.0) + angle)*180,pi)
        ...
        if self._agwStyle & SM_DRAW_GRADIENT:
            ...
            radiusteps = old_div(flrect,numsteps)
            interface = 0
