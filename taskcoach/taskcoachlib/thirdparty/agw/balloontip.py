...
class BalloonFrame(wx.Frame):
    ...
    def __init__(self, parent, id=wx.ID_ANY, pos=wx.DefaultPosition,
        ...
        if self._toptitle != "":
            ...
            stt.set_font(wx.Font(9, wx.SWISS, wx.NORMAL, wx.BOLD, False))
            ...
            self._balloontitle.set_font(self._balloontitlefont)

        if self._tipstyle == BT_BUTTON:
            self._closebutton = GenButton(panel, -1, "X", style=wx.NO_BORDER)
            self._closebutton.SetMinSize((16,16))
            self._closebutton.set_font(wx.Font(9, wx.SWISS, wx.NORMAL, wx.BOLD, False))
        ...
        self._balloonmsg.set_font(self._balloonmsgfont)
    ...
    def SetBalloonShape(self, event=None):
        ...
        textfont = self._balloonmsg.get_font()
