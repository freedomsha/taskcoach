        ...
        if width >= self._tabs_total_width_ideal:
            ...
            if width >= total_small_width:
                ...
                for info in self._pages:
                    ...
                    info.rect.x = x
                    info.rect.y = y
                    info.rect.width = info.small_must_have_separator_width + old_div(delta*(width - total_small_width),total_delta)
                    info.rect.height = self._tab_height
                ...
                if width >= total_small_width:
                    ...
                    for i, info in enumerate(self._pages):
                        if info.small_must_have_separator_width*(numtabs - i) <= width:
                            ...
                            info.rect.width = old_div(width,(numtabs - i))
                    ...
                    for info in self._pages:
                        ...
                        info.rect.x = x
                        info.rect.y = y
                        info.rect.width = info.minimum_width + old_div(delta*(width - total_small_width),total_delta)
                        info.rect.height = self._tab_height
