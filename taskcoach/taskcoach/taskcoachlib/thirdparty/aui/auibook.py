...
try:
    from taskcoachlib.thirdparty.aui import framemanager
except ModuleNotFoundError:
    from aui2 import framemanager
try:
    from taskcoachlib.thirdparty.aui import tabart as TA
except ModuleNotFoundError:
    from aui2 import tabart as TA
