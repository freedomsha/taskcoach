...
class ToasterBox(wx.Timer):
    ...
    def CenterOnParent(self, direction=wx.BOTH):
        ...
        if direction == wx.VERTICAL:
            pos = wx.Point(x, (y + (old_div(height,2)) - (old_div(toast_height,2))))
        elif direction == wx.HORIZONTAL:
            pos = wx.Point((x + (old_div(width,2)) - (old_div(toast_width,2))), y)
        else:
            pos = wx.Point((x + (old_div(width,2)) - (old_div(toast_width,2))), (y + (old_div(height,2)) - (old_div(toast_height,2))))
    ...
    def CenterOnScreen(self, direction=wx.BOTH):
        ...
        if direction == wx.VERTICAL:
            pos = wx.Point(0, (old_div(height,2)) - (old_div(toast_height,2)))
        elif direction == wx.HORIZONTAL:
            pos = wx.Point((old_div(width,2)) - (old_div(toast_width,2)), 0)
        else:
            pos = wx.Point((old_div(width,2)) - (old_div(toast_width,2)), (old_div(height,2)) - (old_div(toast_height,2)))
