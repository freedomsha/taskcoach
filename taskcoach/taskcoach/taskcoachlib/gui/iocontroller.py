...
class IOController(object):
    ...
    def __init__(self, taskFile, messageCallback, settings, splash=None):
        ...
        self.__errorMessageOptions = dict(caption=_('%s file error') % meta.name, style=wx.ICON_ERROR)
    ...
    def __askUserForOverwriteConfirmation(self, filename, title,
        ...
        if result == wx.YES:
            ...
            for auto in set(
                    self.__settings.getlist('file', 'autoimport') + self.__settings.getlist('file', 'autoexport')):
