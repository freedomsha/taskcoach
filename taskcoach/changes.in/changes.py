...
of Task Coach, allowing several users to work on the same file.''',
                        'http://taskcoach.uservoice.com/forums/26465-desktop-version-windows-linux-mac-of-task-coach'
                        '/suggestions/288999-enable-multi-user-task-management'),
            ...
            bugsFixed=[
                ...
                Bugv2('''Don't crash at startup if the locale is not supported.''', '1528'),
            ],
            ),
...
sync is enabled.'''),
            ...
            featuresAdded=[
                Feature('''Add an "add note to selected task" button in
...
sessions.''',
                        'http://taskcoach.uservoice.com/forums/26465-desktop-version-windows-linux-mac-of-task-coach'
                        '/suggestions/289031-better-control-over-task-order'),
            ],
            ),
...
file names.''',
                        'https://taskcoach.uservoice.com/admin/forums/26465-desktop-version-windows-linux-mac-of-task'
                        '-coach/suggestions/5721924-use-slash-instead-backslash-on-attachment-file-pat'),
                Feature('''New hierarchical calendar viewer.'''),
                Feature('''Efforts and notes are always enabled.'''),
                Feature('''Display categories in tooltip.''',
                        'https://taskcoach.uservoice.com/admin/forums/26465-desktop-version-windows-linux-mac-of-task'
                        '-coach/suggestions/5727692-tooltips-for-grid-cells-with-too-long-contents-to'),
                Feature('''The tooltip is now always enabled.'''),
                Feature('''Manual reordering of tasks, categories and notes.''',
                        'http://taskcoach.uservoice.com/forums/26465-desktop-version-windows-linux-mac-of-task-coach'
                        '/suggestions/289031-better-control-over-task-order'),
            ],
            dependenciesChanged=[
...
from Tom Monaco).''',
                        'https://taskcoach.uservoice.com/admin/forums/26465-desktop-version-windows-linux-mac-of-task'
                        '-coach/suggestions/739042-allow-display-of-effort-in-decimal-dd-dd-as-wel'),
                Feature('''Improved import/export of Todo.txt'''),
                Feature('''Custom attributes for mailing tasks/categories/etc''',
                        'https://taskcoach.uservoice.com/admin/forums/26465-desktop-version-windows-linux-mac-of-task'
                        '-coach/suggestions/5342642-embeded-command-capability'),
            ],
            dependenciesChanged=[
...
from Ivan Romanov).''',
                        'https://taskcoach.uservoice.com/admin/forums/26465-desktop-version-windows-linux-mac-of-task'
                        '-coach/suggestions/606269-section-in-status-bar-for-calculated-information-a'),
