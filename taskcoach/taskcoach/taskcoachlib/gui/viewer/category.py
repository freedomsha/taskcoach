...
class BaseCategoryViewer(mixin.AttachmentDropTargetMixin,  # pylint: disable=W0223
    ...
    def _createColumns(self):
        ...
        columns = [widgets.Column('ordering', u'',
                   ...
                   widgets.Column('notes', '',
                                  category.Category.notesChangedEventType(),  # problème Unresolved
                                  # pylint: disable=E1101
                                  width=self.getColumnWidth(
                                      'notes'),
                                  alignment=wx.LIST_FORMAT_LEFT,
                                  imageIndicesCallback=self.noteImageIndices,
                                  headerImageIndex=self.imageIndex[
                                      'note_icon'],
                                  renderCallback=lambda category: '',
                                  **kwargs),
    ...
    def createColumnUICommands(self):
        commands = [uicommand.ToggleAutoColumnResizing(viewer=self,
