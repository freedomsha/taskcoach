...
class HyperLinkCtrl(StaticText):
    ...
    def __init__(self, parent, id=-1, label="", pos=wx.DefaultPosition,
        ...
        :param `URL`: a string specifying the urlpo link to navigate to.

        :note: Pass URL="" to use the label as the urlpo link to navigate to.
        """
    ...
    def GotoURL(self, URL, ReportErrors=True, NotSameWinIfPossible=False):
        ...
        :param `URL`: the urlpo link we wish to navigate;
