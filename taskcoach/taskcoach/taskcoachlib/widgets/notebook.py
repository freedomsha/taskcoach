...
import aui2 as aui
from aui2.auibook import AuiNotebook
import wx


class GridCursor(object):
...
class BookMixin(object):  # metaclass de aui.auibook.AuiNotebook et (wx.PyEventBinder ou wx.EvtHandler)?
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        # self.Bind((wx.EVT_BUTTON, self.pageChangedEvent, self.onPageChanged) à la place ?
    ...
    def AddPage(self, page, name, bitmap=None):
        ...
        # aui.auibook.AuiNotebook.AddPage(self, page, caption, select=False, bitmap=wx.NullBitmap,
        # disabled_bitmap=wx.NullBitmap, control=None, tooltip="")
        bitmap = wx.ArtProvider.GetBitmap(bitmap, wx.ART_MENU, self._bitmapSize)
...
class Notebook(BookMixin, aui.AuiNotebook):
    ...
    def __init__(self, *args, **kwargs):
        ...
        kwargs['agwStyle'] = defaultStyle & ~aui.AUI_NB_CLOSE_ON_ACTIVE_TAB & ~aui.AUI_NB_MIDDLE_CLICK_CLOSE
