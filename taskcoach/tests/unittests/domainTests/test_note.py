...
class NoteTest(tctest.TestCase):
    ...
    def testDefaultDescription(self):
        self.assertEqual("", self.note.getDescription())

    def testGivenDescription(self):
        aNote = note.Note(description="Description")
        self.assertEqual("Description", aNote.getDescription())

    def testSetDescription(self):
        self.note.setDescription("Description")
        self.assertEqual("Description", self.note.getDescription())
    ...
    def testSetState(self):
        ...
        self.assertEqual("new", self.note.getDescription())


# class NoteOwnerUnderTest(base.NoteOwner, base.Object):
class NoteOwnerUnderTest(note.noteowner.NoteOwner, base.Object):
    pass
