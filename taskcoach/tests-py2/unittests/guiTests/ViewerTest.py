...
class ViewerTest(test.wxTestCase):
    ...
    def testGetItemTooltipData(self):
        ...
        expectedData = [('led_grey_icon', ['task']), ('folder_blue_arrow_icon', []), ('paperclip_icon', []), (None, ['Description'])]
...
class SearchableViewerTest(test.TestCase):
    ...
    def testSetSearchFilterString(self):
        ...
        self.assertEqual('bla', self.settings.get(self.viewer.settingsSection(), 'searchfilterstring'))
    ...
    def testSearchMatchCase(self):
        ...
        self.assertEqual(True,
                         self.settings.getboolean(self.viewer.settingsSection(), 'searchfiltermatchcase'))
    ...
    def testSearchIncludesSubItems(self):
        ...
        self.assertEqual(True,
                         self.settings.getboolean(self.viewer.settingsSection(), 'searchfilterincludesubitems'))
    ...
    def testSearchDescription(self):
        ...
        self.assertEqual(True, self.settings.getboolean(self.viewer.settingsSection(), 'searchdescription'))
...
class FilterableViewerForTasks(test.TestCase):
    ...
    def testHideInactiveTasks_SetsSetting(self):
        self.viewer.hideTaskStatus(task.status.inactive)
        self.failUnless(self.settings.getboolean(self.viewer.settingsSection(), 'hideinactivetasks'))
    ...
    def testHideLateTasks_SetsSetting(self):
        self.viewer.hideTaskStatus(task.status.late)
        self.failUnless(self.settings.getboolean(self.viewer.settingsSection(), 'hidelatetasks'))
    ...
    def testHideDueSoonTasks_SetsSetting(self):
        self.viewer.hideTaskStatus(task.status.duesoon)
        self.failUnless(self.settings.getboolean(self.viewer.settingsSection(), 'hideduesoontasks'))
    ...
    def testHideOverDueTasks_SetsSetting(self):
        self.viewer.hideTaskStatus(task.status.overdue)
        self.failUnless(self.settings.getboolean(self.viewer.settingsSection(), 'hideoverduetasks'))
    ...
    def testHideCompletedTasks_SetsSetting(self):
        self.viewer.hideTaskStatus(task.status.completed)
        self.failUnless(self.settings.getboolean(self.viewer.settingsSection(), 'hidecompletedtasks'))
    ...
    def testHideCompositeTasks_SetsSettings(self):
        self.viewer.hideCompositeTasks()
        self.failUnless(self.settings.getboolean(self.viewer.settingsSection(), 'hidecompositetasks'))
