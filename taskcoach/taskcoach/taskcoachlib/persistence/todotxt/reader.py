...
class TodoTxtReader(object):  # nouvelle classe
        ...
        if os.path.exists(metaName):
            ...
            with codecs.open(metaName, 'r', 'utf-8') as fp:
                ...
                for line in fp:
                    line = line.strip()
                    try:
                        taskId, subjects, priority, plannedStartDateTime, completionDateTime, dueDateTime, \
                            categories = self.__processLine(line, todoTxtRE, keyValueRE, date.Now, None)
    ...
    @staticmethod
    def findOrCreateCompositeItem(subject, parent, subjectCache,
