...
class SetAttribute(object):
    ...
    def __init__(self, values, owner, addEvent=None, removeEvent=None, changeEvent=None, weak=False):
        ...
        self.__owner = weakref.ref(owner)
        self.__addEvent = (addEvent or self.__null_event).__func__
        self.__removeEvent = (removeEvent or self.__null_event).__func__
        self.__changeEvent = (changeEvent or self.__null_event).__func__
    ...
    def __null_event(self, *args, **kwargs):
        pass
