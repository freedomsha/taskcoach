...
class EventTest(tctest.TestCase):
    def setUp(self):
        super().setUp()
...
class ListDecoratorTest_Constructor(tctest.TestCase):
...
class SetDecoratorTest_Constructor(tctest.TestCase):
    def testOriginalNotEmpty(self):
...
class ListDecoratorTest_AddItems(tctest.TestCase):
    def setUp(self):
        super().setUp()
...
class SetDecoratorTest_AddItems(tctest.TestCase):
    def setUp(self):
        super().setUp()
        self.observable = patterns.ObservableList()
...
class ListDecoratorTest_RemoveItems(tctest.TestCase):
    def setUp(self):
        super().setUp()
        self.observable = patterns.ObservableList()
        self.observer = patterns.ListDecorator(self.observable)
...
class SetDecoratorTest_RemoveItems(tctest.TestCase):
    def setUp(self):
        super().setUp()
        self.observable = patterns.ObservableList()
        self.observer = patterns.SetDecorator(self.observable)
...
class ListDecoratorTest_ObserveTheObserver(tctest.TestCase):
    def setUp(self):
        super().setUp()
...
class PublisherTest(tctest.TestCase):
    ...
    def testRegisterObserver(self):
        ...
        self.assertEqual(set([self.onEvent]), self.publisher.observers())
    ...
    def testGetObservers_WithoutObservers(self):
        self.assertEqual(set(), self.publisher.observers())

    def testGetObserversForSpecificEventType_WithoutObservers(self):
        self.assertEqual(set(), self.publisher.observers(eventType='eventType'))

    def testGetObserversForSpecificEventType_WithObserver(self):
        self.publisher.registerObserver(self.onEvent, eventType='eventType')
        self.assertEqual(set([self.onEvent]),
    ...
    def testRemoveObserverForSpecificType_RegisteredForDifferentTypeThatHasObservers(self):
        ...
        self.publisher.removeObserver(self.onEvent, eventType='otherType')
        self.assertEqual(set([self.onEvent]), self.publisher.observers('eventType'))
