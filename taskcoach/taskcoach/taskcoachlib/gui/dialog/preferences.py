...
class SettingsPageBase(widgets.BookPage):
    ...
    def addAppearanceSetting(self, fgColorSection, fgColorSetting,
        ...
        iconEntry = adv.BitmapComboBox(self, style=wx.CB_READONLY)
    ...
    def ok(self):
        ...
        for section, setting, iconEntry in self._iconSettings:
            icon_name = iconEntry.GetClientData(iconEntry.GetSelection())
            self.settext(section, setting, icon_name)
...
class WindowBehaviorPage(SettingsPage):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(columns=2, growableColumn=-1,
                         *args, **kwargs)
...
class TaskDatesPage(SettingsPage):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(columns=4, growableColumn=-1,
                         *args, **kwargs)
