...
from . import toolbar, uicommand, remindercontroller, \
    artprovider, windowdimensionstracker, idlecontroller
from taskcoachlib.gui.newid import IdProvider
from .viewer import container, factory
from .dialog.iphone import IPhoneSyncTypeDialog
from .dialog.xfce4warning import XFCE4WarningDialog
from .dialog.editor import Editor
from .iphone import IPhoneSyncFrame
...
If this happens again, please make a copy of your TaskCoach.ini file '''
    ...
    def __onDirtyChanged(self, task_file):
        self.__dirty = task_file.isDirty()
        self.__setTitle()
