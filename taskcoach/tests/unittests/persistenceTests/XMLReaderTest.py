...
class XMLReaderVersion13Test(XMLReaderTestCase):
    ...
    def testSubTaskWithCategories(self):
        ...
        # print(f"Catégorie 'another' contient : {[obj.id() for obj in anotherCategory.categorizables()]}")
        # print(f"🔎 TEST - Catégorie de la sous-tâche après parsing : {tasks[0].children()[0].categories()}")
        ...
        self.assertEqual({anotherCategory}, tasks[0].children()[0].categories())
...
class XMLReaderVersion20Test(XMLReaderTestCase):
    ...
    def testReadEmptyStream(self):
        ...
        try:
            ...
            tasks, categories, notes, syncml_config, changes, guid = reader.read()
    ...
    def testTaskWithOneAttachment(self):
        ...
        self.assertEqual(
            [os.path.join(os.getcwd(), "testfile_attachments", "whateverdata.tsk")],
            [att.location() for att in tasks[0].attachments()],
        )
        self.assertEqual(
            ["whatever.tsk"], [att.subject() for att in tasks[0].attachments()]
    ...
    def testCategoryWithOneAttachment(self):
        ...
        self.assertEqual(
            ["whatever.tsk"], [att.subject() for att in categories[0].attachments()]
        )
    ...
    def testTaskWithTwoAttachments(self):
        ...
        self.assertEqual(
            [
                os.path.join(os.getcwd(), "testfile_attachments", "whateverdata.tsk"),
                os.path.join(os.getcwd(), "testfile_attachments", "anotherdata.txt"),
            ],
            [att.location() for att in tasks[0].attachments()],
        )
        self.assertEqual(
...
class XMLReaderVersion21Test(XMLReaderTestCase):
    ...
    def testAttachmentLocation(self):
        ...
        self.assertEqual(
            ["location"],
            [os.path.split(att.location())[-1] for att in categories[0].attachments()],
        )
...
class XMLReaderVersion28Test(XMLReaderTestCase):
    ...
    def testNoTaskFont(self):
        tasks = self.writeAndReadTasks('<tasks>\n<task subject="Task"/>\n</tasks>\n')
...
class XMLReaderVersion30Test(XMLReaderTestCase):
    ...
    def testStartDateTime(self):
        ...
        self.assertEqual(
            date.DateTime(2005, 4, 17, 10, 5, 11), tasks[0].plannedStartDateTime()
        )
    ...
    def testStartDateTimeWithMicroseconds(self):
        ...
        self.assertEqual(
            date.DateTime(2005, 1, 1, 22, 1, 30, 456), tasks[0].plannedStartDateTime()
        )
    ...
    def testDueDateTime(self):
        ...
        self.assertEqual(date.DateTime(2005, 4, 17, 13, 5, 59), tasks[0].dueDateTime())
    ...
    def testDueDateTimeWithoutTime(self):
        ...
        self.assertEqual(
            date.DateTime(2005, 4, 17, 23, 59, 59, 999999), tasks[0].dueDateTime()
        )
    ...
    def testDueDateTimeWithMicroseconds(self):
        ...
        self.assertEqual(
            date.DateTime(2005, 1, 1, 22, 1, 30, 456000), tasks[0].dueDateTime()
        )
    ...
    def testCompletionDateTimeWithMicroseconds(self):
        ...
        self.assertEqual(
            date.DateTime(2005, 1, 1, 22, 1, 30, 456000), tasks[0].completionDateTime()
        )
        self.assertTrue(tasks[0].completed())
    ...
    def testCompletionDateTimeWithoutTime(self):
        ...
        self.assertEqual(
            date.DateTime(2005, 1, 1, 23, 59, 59, 999999), tasks[0].completionDateTime()
        )
        self.assertTrue(tasks[0].completed())
...
class XMLReaderVersion33Test(XMLReaderTestCase):
    ...
    def testReminderBeforeSnooze(self):
        ...
        self.assertEqual(
            date.DateTime(2004, 1, 1, 9, 0, 0), tasks[0].reminder(includeSnooze=False)
        )
        self.assertEqual(date.DateTime(2004, 1, 1, 10, 0, 0), tasks[0].reminder())
    ...
    def testReminder(self):
        ...
        self.assertEqual(
            date.DateTime(2004, 1, 1, 10, 0, 0), tasks[0].reminder(includeSnooze=False)
        )
        self.assertEqual(date.DateTime(2004, 1, 1, 10, 0, 0), tasks[0].reminder())
...
class XMLReaderVersion34Test(XMLReaderTestCase):
    ...
    def testActualStartDateTime(self):
        ...
        self.assertEqual(
            date.DateTime(2005, 4, 17, 10, 5, 11), tasks[0].actualStartDateTime()
        )
    ...
    def testActualStartDateTimeWithMicroseconds(self):
        ...
        self.assertEqual(
            date.DateTime(2005, 1, 1, 22, 1, 30, 456), tasks[0].actualStartDateTime()
        )
...
class XMLReaderVersion35Test(XMLReaderTestCase):
    ...
    def testRecurrenceStopDateTime(self):
        ...
        self.assertEqual(
            date.DateTime(2000, 1, 10, 13, 13, 13), tasks[0].recurrence().stop_datetime
        )
...
class XMLReaderVersion36Test(XMLReaderTestCase):
    ...
    def testCreationDateTime(self):
        ...
        self.assertEqual(
            date.DateTime(2012, 12, 12, 12, 0, 0, 12345), tasks[0].creationDateTime()
        )
...
class XMLReaderVersion37Test(XMLReaderTestCase):
    ...
    def testAdjustDueDateTime(self):
        ...
        self.assertEqual(
            date.DateTime(2012, 12, 12, 23, 59, 59, 999999), tasks[0].dueDateTime()
        )
    ...
    def test_dontAdjustPlannedStartDateTime(self):
        ...
        self.assertEqual(
            date.DateTime(2012, 12, 12, 23, 59, 0, 0), tasks[0].plannedStartDateTime()
        )
    ...
    def test_dontAdjustActualStartDateTime(self):
        ...
        self.assertEqual(
            date.DateTime(2012, 12, 12, 23, 59, 0, 0), tasks[0].actualStartDateTime()
        )
    ...
    def test_dontAdjustCompletionDateTime(self):
        ...
        self.assertEqual(
            date.DateTime(2012, 12, 12, 23, 59, 0, 0), tasks[0].completionDateTime()
        )
