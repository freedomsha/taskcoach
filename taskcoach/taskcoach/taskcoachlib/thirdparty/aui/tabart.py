...
class AuiDefaultTabArt(object):
    """
    Tab art provider code - a tab provider provides all drawing
    functionality to the :class:`~lib.agw.aui.auibook.AuiNotebook`.
    ...
    Call :meth:`AuiNotebook.SetArtProvider() <lib.agw.aui.auibook.AuiNotebook.SetArtProvider>` to make use this
    new tab art.
    """
    ...
    def DrawFocusRectangle(self, dc, page, wnd, draw_text, text_offset, bitmap_offset, drawn_tab_yoff, drawn_tab_height,
        ...
        global focusRectBitmap  # nouvelle ligne proposée par la ligne 822(809)
        ...
        if page.active and wx.Window.FindFocus() == wnd:
            ...
            # Local variable 'focusRect' might be referenced before assignment
