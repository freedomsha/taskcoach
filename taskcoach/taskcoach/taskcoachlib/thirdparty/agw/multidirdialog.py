...
class MultiDirDialog(wx.Dialog):
    ...
    def SetupDirCtrl(self, defaultPath):
        ...
        # closed folder:
        il.Add(_folder_close.get_bitmap())

        # open folder:
        il.Add(_folder_open.get_bitmap())

        # root of filesystem (linux):
        il.Add(_computer.get_bitmap())

        # drive letter (windows):
        il.Add(_hd.get_bitmap())

        # cdrom drive:
        il.Add(_cdrom.get_bitmap())

        # removable drive on win98:
        il.Add(_removable.get_bitmap())
        ...
        self.folderText.set_value(treeCtrl.GetItemText(treeCtrl.GetSelections()[0]))
    ...
    def LayoutItems(self, message):
        ...
        f = staticText.get_font()
        f.SetWeight(wx.BOLD)
        staticText.set_font(f)
    ...
    def CreateButtons(self):
        ...
        self.newButton = buttons.ThemedGenBitmapTextButton(self, wx.ID_NEW, _new.get_bitmap(),
                                                           _("Make New Folder"), size=(-1, 28))
        self.okButton = buttons.ThemedGenBitmapTextButton(self, wx.ID_OK, _ok.get_bitmap(),
                                                          _("OK"), size=(-1, 28))
        self.cancelButton = buttons.ThemedGenBitmapTextButton(self, wx.ID_CANCEL, _cancel.get_bitmap(),
                                                              _("Cancel"), size=(-1, 28))
    ...
    def OnSelChanged(self, event):
        ...
        self.folderText.set_value(text)
