...
fileQuit = _('Exit {}'.format(*meta.name))
# fileQuit = _(f'Exit {*meta.name}')
# fileOpen = _('Open a %s file') % meta.name
fileOpen = _('Open a {} file'.format(*meta.name))
...
help = _('Help about the program')  # pylint: disable=W0622 Shadows built-in name 'help' TODO: rename to tcHelp ?
