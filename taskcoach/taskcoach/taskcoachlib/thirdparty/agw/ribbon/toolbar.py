...
class RibbonToolBar(RibbonControl):
    ...
    def Realize(self):
        ...
        for group in self._groups:
            ...
            for t, tool in enumerate(group.tools):
                ...
                tool.size, tool.dropdown = self._art.get_tool_size(temp_dc, self, tool.bitmap.GetSize(), tool.kind, t == 0, t == (tool_count - 1))
    ...
    def OnSize(self, event):
        ...
        rowsep = old_div((size.GetHeight() - total_height), (row_count + 1))
        rowypos = [0]*row_count
        rowypos[0] = rowsep
        for r in range(1, row_count):          
