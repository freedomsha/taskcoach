...
if operating_system.isGTK():
    ...
    class LinuxIdleQuery(object):
        def __init__(self):
            ...
            self.XScreenSaverQueryInfo = CFUNCTYPE(c_int, c_ulong, c_ulong,
                                                   POINTER(XScreenSaverInfo))(('XScreenSaverQueryInfo', _xss))
        ...
        def getIdleSeconds(self):
            ...
            return old_div(1.0 * self.info.contents.idle, 1000)
    ...
    class WindowsIdleQuery(object):
        ...
        def getIdleSeconds(self):
            ...
            return old_div((1.0 * self.GetTickCount() - self.lastInputInfo.dwTime), 1000)
