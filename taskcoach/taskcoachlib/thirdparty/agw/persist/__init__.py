...
* Set a unique name for the window using `set_name()`: this step is important as the
...
Example of using a notebook control which automatically remembers the last open page::
    ...
    class MyFrame(wx.Frame):
        ...
        def __init__(self, parent):
            ...
            # Very important step!!            
            book.set_name("MyBook") # Do not use the default name!!
...
`PersistentObject.get_name()` method too. Additionally, you must ensure that
