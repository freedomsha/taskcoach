...
class DailyRecurrenceTest(
    tctest.TestCase, CommonRecurrenceTestsMixin, DailyRecurrenceCompareTestsMixin
):
    def setUp(self):
...
class BiDailyRecurrenceTest(
    ...
    def testEveryOtherDay(self):
        self.assertEqual(self.now + date.ONE_DAY, self.recur(self.now - date.ONE_DAY))
...
class WeeklyRecurrenceTest(
    tctest.TestCase, CommonRecurrenceTestsMixin, WeeklyRecurrenceCompareTestsMixin
):
    def setUp(self):
...
class MonthlyRecurrenceTest(
    tctest.TestCase, CommonRecurrenceTestsMixin, MonthlyRecurrenceCompareTestsMixin
):
    def setUp(self):
...
class YearlyRecurrenceTest(
    tctest.TestCase, CommonRecurrenceTestsMixin, YearlyRecurrenceCompareTestsMixin
):
    def setUp(self):
...
class YearlySameWeekDayRecurrenceTest(
    ...
    def testLastWednesdayOfTheYear(self):
        self.assertEqual(
            date.DateTime(2009, 12, 30), self.recur(date.DateTime(2008, 12, 31))
        )

    def testLastTuesdayOfTheYear(self):
        self.assertEqual(
            date.DateTime(2009, 12, 29), self.recur(date.DateTime(2008, 12, 30))
        )

    def testLastMondayOfTheYear(self):
        self.assertEqual(
            date.DateTime(2009, 12, 28), self.recur(date.DateTime(2008, 12, 29))
        )

    def testLastSundayOfTheYear(self):
        self.assertEqual(
            date.DateTime(2009, 12, 27), self.recur(date.DateTime(2008, 12, 28))
        )

    def testLastSaturdayOfTheYear(self):
        self.assertEqual(
            date.DateTime(2009, 12, 26), self.recur(date.DateTime(2008, 12, 27))
        )

    def testLastFridayOfTheYear(self):
        self.assertEqual(
            date.DateTime(2009, 12, 25), self.recur(date.DateTime(2008, 12, 26))
        )

    def testLastThursdayOfTheYear(self):
        self.assertEqual(
            date.DateTime(2009, 12, 24), self.recur(date.DateTime(2008, 12, 25))
        )
...
class MaxRecurrenceTest(tctest.TestCase, CommonRecurrenceTestsMixin):
    ...
    def testFirst(self):
        self.assertEqual(
            date.DateTime(2000, 1, 2), self.recur(date.DateTime(2000, 1, 1), next=True)
        )
