...
#        else:
    ...
    def CombineAttr(self, attr):
        ...
        attr.set_text_colour(self.text_colour)
        attr.set_font(self.font)
    ...
    def Draw(self, dc, rect):
        ...
        xshift = yshift = 0
        if self.rotation:
            xshift = cos(old_div(self.rotation*pi,180))
            yshift = sin(old_div(self.rotation*pi,180))
        ...
        if xshift > 0:
            new_width = old_div(new_width,xshift)
        ...
        if self.rotation:
            ...
            xc, yc = (rect.x+old_div(rect.width,2), rect.y+old_div(rect.height,2))
            xp = xc - (old_div(text_width,2))*xshift - (old_div(text_height,2))*yshift
            yp = yc + (old_div(text_width,2))*yshift - (old_div(text_height,2))*xshift
