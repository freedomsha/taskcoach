...
class TodoTxtWriter(object):
    ...
    def startDate(cls, plannedStartDateTime):
        return '%s ' % cls.dateTime(plannedStartDateTime) if \
            cls.isActualDateTime(plannedStartDateTime) else ''
    ...
    def completionDate(cls, completionDateTime):
        return 'X ' + '%s ' % cls.dateTime(completionDateTime) if \
            cls.isActualDateTime(completionDateTime) else ''
