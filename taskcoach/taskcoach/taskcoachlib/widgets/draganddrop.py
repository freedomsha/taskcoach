...
class DropTarget(wx.DropTarget):
    ...
    def reinit(self):
        ...
        self.__macMailObject = wx.CustomDataObject('public.urlpo')
    ...
    def getReceivedFormatTypeAndId(self):
        ...
        try:
            formatId = receivedFormat.get_id()
        except:
    ...
    def __tmp_mail_file_url(url):
        """ Return whether the urlpo is a dropped mail message. """
