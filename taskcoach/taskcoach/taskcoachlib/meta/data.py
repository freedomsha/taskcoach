...
if revision:  # Buildbot sets revision
    ...
    release_status = 'beta'
    version += '.' + revision  # expected type str, got None instead
...
urlpo = url = 'http://taskcoach.org/'  # Don't remove the trailing slash, other code is assuming it will be there
