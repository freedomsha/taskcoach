...
defaults = {
    ...
    'taskviewer': {
        ...
        'toolbarperspective': 'TaskNew,NewSubItem,TaskNewFromTemplateButton,Separator,Edit,Delete,Separator,'
                              'TaskMarkInactive,TaskMarkActive,TaskMarkCompleted,Separator,EffortStart,EffortStop,'
                              'Separator,Spacer,ViewerHideTasks_completed,ViewerHideTasks_inactive,ResetFilter,'
                              'TaskViewerTreeOrListChoice,Search',
