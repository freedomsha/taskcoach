...
class TaskSorterSettingsTest(tctest.TestCase):
    ...
    def testAlwaysKeepSubscriptionToCompletionDateTime(self):
        """TaskSorter doit conserver un abonnement à task.completionDateTime
        même lorsque la date d'achèvement n'est pas la clé de tri, car le tri
        selon l'état de la tâche (active, terminée, etc.) dépend de la date
        d'achèvement.
        """
    ...
    def testAlwaysKeepSubscriptionToPlannedStartDateTime(self):
        """TaskSorter doit conserver un abonnement à task.plannedStartDateTime
        même lorsque la date de début prévue n'est pas la clé de tri, car le tri
        selon l'état de la tâche (active, terminée, etc.) dépend de la date de
        début prévue.
        """
        self.sorter.sortBy("subject")
        self.sorter.sortAscending()
    ...
    def testAlwaysKeepSubscriptionToActualStartDateTime(self):
        """TaskSorter doit conserver un abonnement à task.actualStartDateTime
        même lorsque la date de début réelle n'est pas la clé de tri, car le tri
        selon l'état de la tâche (active, terminée, etc.) dépend de la date de
        début réelle.
        """
        self.sorter.sortBy("subject")
